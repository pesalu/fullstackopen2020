...
describe('<Blog />', () => {
  ...
  let component;
  beforeEach(() => {
    component = render(<Blog blog={blog}  handleLikesIncrements={onClick} handleRemovalOfBlog={onClick}/>);
  });
  ...
  test('clicking like -button two times calls event handler twice', () => {
    ...
    component = render(<Blog blog={blog}  handleLikesIncrements={mockHandler} handleRemovalOfBlog={onClick}/>);
