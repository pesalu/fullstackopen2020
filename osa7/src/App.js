...
const App = () => {
  ...
  const currentAnecdote = match ? anecdotes.find( anecdote => anecdote.id === match.params.id ) : null;
  ...
  return (
    <div>
      ...
      <Switch>
        <Route path="/anecdotes/:id"><Anecdote anecdote={currentAnecdote} /></Route>
